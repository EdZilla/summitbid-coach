            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="nutritionInfo.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: nutritionInfoInstance, field: "id")}</td>
