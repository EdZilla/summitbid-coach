                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="id" title="${message(code: 'exercise.id.label', default: 'Id')}" />
                        
                            <g:sortableColumn property="name" title="${message(code: 'exercise.name.label', default: 'Name')}" />
                        
                            <g:sortableColumn property="end" title="${message(code: 'exercise.end.label', default: 'End')}" />
                        
                            <g:sortableColumn property="start" title="${message(code: 'exercise.start.label', default: 'Start')}" />
                    ...
                    <g:each in="${exerciseInstanceList}" status="i" var="exerciseInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: exerciseInstance, field: "name")}</td>
                        
                            <td><g:formatDate date="${exerciseInstance.end}" /></td>
                        
                            <td><g:formatDate date="${exerciseInstance.start}" /></td>
