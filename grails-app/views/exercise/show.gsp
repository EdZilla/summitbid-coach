            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="exercise.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="exercise.end.label" default="End" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${exerciseInstance?.end}" /></td>
